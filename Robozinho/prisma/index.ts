...
async function main() {
  ...
  const members = await prisma.member.createMany({
    data: [
        ...
        { name: 'Erica Moura', user: 'EricaM', password: '!@#@!#!@#', userWtp: '@3ricautora', phone: '85999999999', age: 30, points: getRandomPoints(), role: '', subs: ['Luna-B2', 'Luna-B3'] },
        ...
        { name: 'Jana Heloísa', user: 'JanaH', password: '!@#@!#!@#', userWtp: '@JanaHSupernova', phone: '85999999999', age: 29, points: getRandomPoints(), role: '', subRole: '', subs: ['Luna-B11'] },
        { name: 'Jorge Cardoso', user: 'JcBushido', password: '!@#@!#!@#', userWtp: '@JCBushido', phone: '85999999999', age: 99, points: getRandomPoints(), role: 'superadm', subRole: 'adm', subs: ['Luna-B12'] },
        ...
        { name: 'Jeferson', user: 'JeffX', password: '!@#@!#!@#', userWtp: '@Jeffantasies', phone: '85999999999', age: 32, points: getRandomPoints(), role: '', subs: ['Luna-B17'] },
